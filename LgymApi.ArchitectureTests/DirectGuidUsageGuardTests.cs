...
public sealed class DirectGuidUsageGuardTests
{
    ...
    private static bool IsExcludedPath(string path)
    {
        ...
        if (normalized.EndsWith("/LgymApi.Domain/ValueObjects/Id.cs", StringComparison.OrdinalIgnoreCase)
            || normalized.EndsWith("/ValueObjects/Id.cs", StringComparison.OrdinalIgnoreCase))
        {
            return true;
        }
        ...
        if (normalized.EndsWith(".g.cs", StringComparison.OrdinalIgnoreCase)
            ...
            || normalized.Contains("/service references/", StringComparison.OrdinalIgnoreCase)
            || normalized.Contains("/connected services/", StringComparison.OrdinalIgnoreCase))
        {
            return true;
        }

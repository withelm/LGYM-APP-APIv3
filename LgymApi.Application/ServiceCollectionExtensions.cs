...
public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddApplicationServices(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IEloCalculationStrategy, StandardEloCalculationStrategy>();
        services.AddSingleton<IEloCalculationStrategy, AssistanceEloCalculationStrategy>();
        services.AddSingleton<IEloCalculationStrategyResolver, EloCalculationStrategyResolver>();
        services.AddSingleton<IRecordComparisonStrategy, StandardRecordComparisonStrategy>();
        services.AddSingleton<IRecordComparisonStrategy, AssistanceRecordComparisonStrategy>();
        services.AddSingleton<IRecordComparisonStrategyResolver, RecordComparisonStrategyResolver>();

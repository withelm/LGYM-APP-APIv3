...
public interface IPlanDayService
{
    ...
    Task<PlanDayDetailsContext> GetPlanDayAsync(UserEntity currentUser, Guid planDayId, IReadOnlyList<string> cultures, CancellationToken cancellationToken = default);
    Task<PlanDaysContext> GetPlanDaysAsync(UserEntity currentUser, Guid planId, IReadOnlyList<string> cultures, CancellationToken cancellationToken = default);

...
public sealed class InvitationRevokedEmailPayload : IEmailPayload
{
    ...
    public EmailNotificationType NotificationType => Domain.Notifications.EmailNotificationTypes.TrainerInvitationRevoked;

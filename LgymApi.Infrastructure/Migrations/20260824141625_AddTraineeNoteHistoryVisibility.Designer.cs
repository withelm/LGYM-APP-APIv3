...
namespace LgymApi.Infrastructure.Migrations
{
    ...
    [Migration("20260824141625_AddTraineeNoteHistoryVisibility")]
    partial class AddTraineeNoteHistoryVisibility
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.ApiIdempotencyRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ScopeTuple", "IdempotencyKey")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.HasIndex("ScopeTuple", "IdempotencyKey", "RequestFingerprint")
                        .HasFilter("\"IsDeleted\" = FALSE");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.EmailNotificationSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("EmailNotificationSubscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.InAppNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.NotificationMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Channel", "Type", "CorrelationId", "Recipient")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.PushInstallation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.RoleClaim", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("a3b7c9d1-4e5f-6a7b-8c9d-0e1f2a3b4c5d"),
                            ClaimType = "permission",
                            ClaimValue = "trainer.access",
                            CreatedAt = new DateTimeOffset(new DateTime(2026, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
                            IsDeleted = false,
                            RoleId = new Guid("8c1a3db8-72a3-47cc-b3de-f5347c6ae501"),
                            UpdatedAt = new DateTimeOffset(new DateTime(2026, 2, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0))
                        });
                });
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.TraineeNoteHistory", b =>
                {
                    ...
                    b.Property<bool>("NewVisibleToTrainee")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                    ...
                    b.Property<bool?>("PreviousVisibleToTrainee")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.UserExternalLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.UserTutorialProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.UserTutorialStepProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("TutorialStep")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.Property<Guid>("UserTutorialProgressId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("UserTutorialProgressId", "TutorialStep")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = FALSE");

                    b.ToTable("UserTutorialStepProgresses", (string)null);
                });
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.PushInstallation", b =>
                {
                    b.HasOne("LgymApi.Domain.Entities.UserSession", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LgymApi.Domain.Entities.UserTutorialStepProgress", b =>
                {
                    b.HasOne("LgymApi.Domain.Entities.UserTutorialProgress", "UserTutorialProgress")
                        .WithMany("CompletedSteps")
                        .HasForeignKey("UserTutorialProgressId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("UserTutorialProgress");
                });

...
public sealed class TrainerRelationshipControllerTests
{
    ...
    private sealed class StubTrainerRelationshipService : ITrainerRelationshipService
    {
        ...
        public Task<Result<List<WorkoutProgressDashboardTrainingReadModel>, AppError>> GetTraineeTrainingByDateAsync(User currentTrainer, Id<User> traineeId, DateTime createdAt, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<Result<List<ExerciseScoreChartPoint>, AppError>> GetTraineeExerciseScoresChartDataAsync(User currentTrainer, Id<User> traineeId, string exerciseId, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<Result<List<EloChartPoint>, AppError>> GetTraineeEloChartAsync(User currentTrainer, Id<User> traineeId, CancellationToken cancellationToken = default) => throw new NotSupportedException();
        public Task<Result<List<MainRecordReadModel>, AppError>> GetTraineeMainRecordsHistoryAsync(User currentTrainer, Id<User> traineeId, CancellationToken cancellationToken = default) => throw new NotSupportedException();

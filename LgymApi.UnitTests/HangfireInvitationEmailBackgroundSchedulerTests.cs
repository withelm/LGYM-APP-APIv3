...
[TestFixture]
public sealed class HangfireInvitationEmailBackgroundSchedulerTests
{
    [Test]
    public void Enqueue_CreatesHangfireJob_ForInvitationEmailJob()
    {
        var client = new FakeBackgroundJobClient();
        var scheduler = new HangfireInvitationEmailBackgroundScheduler(client);

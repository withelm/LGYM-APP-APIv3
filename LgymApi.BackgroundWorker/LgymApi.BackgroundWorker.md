...
- Notifications boundary: Worker provides the compatibility adapters and runtime implementations for Notification policy, handler execution, and scheduler selection. It does not expose Hangfire or Common types through Application's provider-neutral notification contracts; see [`issue-381-notifications-boundary.md`](../docs/modular-monolith/issue-381-notifications-boundary.md).
